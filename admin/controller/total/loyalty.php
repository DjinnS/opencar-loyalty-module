	...
	*/	
	public function index() { 
		...
		$this->data['button_cancel'] = $this->language->get('button_cancel');
 		...
 		if (isset($this->error['warning'])) {
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('total/loyalty', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = $this->url->link('total/loyalty', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['loyalty_status'])) {
			...
			$this->data['loyalty_status'] = $this->config->get('loyalty_status');
		}
